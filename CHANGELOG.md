...
- The hex is byte for byte identical to the one the native Clang toolchain produces. Two tests
  check it, one through the WebAssembly compiler and one replaying the recipe with native Clang.
